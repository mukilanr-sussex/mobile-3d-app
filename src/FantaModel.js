...
export default function Model({
  ...
  //   "/~mr754/3dapp/assignment/fanta_with_texture.gltf"
  // );
  const { nodes, materials } = useGLTF("/fanta_with_texture.gltf");
  // Debugging wireframe changes
  ...
  return (
    <group ref={group} dispose={null}>
      <group rotation={[Math.PI / 2, 0, 1.5]} scale={0.3}>
        <mesh
          castShadow
          receiveShadow
...
useGLTF.preload("/fanta_with_texture.gltf");
// useGLTF.preload("/~mr754/3dapp/assignment/fanta_with_texture.gltf");
