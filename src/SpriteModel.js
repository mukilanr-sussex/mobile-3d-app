...
export default function Model({
  ...
  //   "/~mr754/3dapp/assignment/sprite_with_texture.gltf"
  // );
  const { nodes, materials } = useGLTF("/sprite_with_texture.gltf");
  ...
  return (
    <group ref={group} dispose={null}>
      <group rotation={[Math.PI / 2, 0, -0.02]} scale={0.3}>
        <mesh
          castShadow
          receiveShadow
...
useGLTF.preload("/sprite_with_texture.gltf");
// useGLTF.preload("/~mr754/3dapp/assignment/sprite_with_texture.gltf");
